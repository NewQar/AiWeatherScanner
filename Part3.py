...
model = load_model("C:\Users\User\Downloads\New folder\Training Image\Weather\Best")
...
testImagesFolder = "C:\Users\User\Downloads\New folder\Training Image\Weather\alien_test"
testImagesNamesDF = pd.read_csv("C:\Users\User\Downloads\New folder\Training Image\test.csv")
testImagesList = []
...
#save the np array
np.save("C:\Users\User\Downloads\New folder\Training Image\ImagesArray.npy", ImagesArray)
